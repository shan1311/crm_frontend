...
function UploadPDF() {
    ...
    const fetchEmployeeDetails = useCallback(async () => {
        setLoading(true);
        try {
            const response = await axios.get('https://crm-backend-g73o.onrender.com/api/assign/empdetails');
    ...
    const fetchClientDetails = useCallback(async () => {
        setLoading(true);
        try {
            const response = await axios.get('https://crm-backend-g73o.onrender.com/api/assign/clients');
    ...
    useEffect(() => {
        ...
        fetchClientDetails();
    },[fetchClientDetails, fetchEmployeeDetails]);
    ...
    const onSubmit = async (event) => {
        ...
        try {
            const uploadResponse = await axios.post('https://crm-backend-g73o.onrender.com/api/assign/upload', formData);
            await axios.post('https://crm-backend-g73o.onrender.com/api/assign/assignClients', {
                employeeId: userId,
                clientIds: clientIds
            });
