...
function Lead() {
  ...
  const fetchUsers = async () => {
    const response = await axios.get('https://crm-backend-g73o.onrender.com/api/lead/lead');
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (currentUser) {
      await axios.put(`https://crm-backend-g73o.onrender.com/api/lead/lead/${currentUser._id}`, form);
    } else {
      await axios.post('https://crm-backend-g73o.onrender.com/api/lead/lead', form);
    }
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://crm-backend-g73o.onrender.com/api/lead/lead/${id}`);
      fetchUsers();
    } catch (err) {
